        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    ...
                    <a href="<?php echo $this->Html->url(array('admin' => true, 'controller' => 'suppliers', 'action' => 'add')); ?>" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Add Supplier</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        table = $('#dataTables-users').DataTable({
            ...
            //"filter":false,        
            "ajax": '<?php echo $this->Html->url(array("controller" => "suppliers", "action" => "index", "admin" => TRUE)); ?>',
            "columns": [
                {"name": "Supplier.id", "orderable": false, "searchable": false, 'width': '4%', 'sClass': 'text-center'},
                {"name": "Supplier.name", 'width': '40%'},
                {"name": "Supplier.contact", 'width': '12%'},
                {"name": "Supplier.email", "orderable": true, "searchable": true, 'width': '12%'},
                {"name": "Supplier.created", "orderable": true, "searchable": true, 'width': '12%'},
                {"name": "Supplier.status", "orderable": false, "searchable": true, 'width': '8%', 'sClass': 'text-center'},
                {"name": "Supplier.common", "orderable": false, "searchable": false, 'width': '10%', 'sClass': 'text-center'},
            ],
            "order": [
